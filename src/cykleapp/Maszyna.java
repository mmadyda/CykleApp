...
public class Maszyna {
    ...
    public static String STYL_BRAK_DANYCH = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#1b1b1b,-5%), derive(#1b1b1b,30%));\n" +
    ...
    public static String STYL_BPRACA = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#32cd32,-5%), derive(#32cd32, 30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_PROBY_TECHNOLOGICZNE = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#8db600,-5%), derive(#8db600,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_POSTOJ_PLANOWANY = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#cccccc,-5%), derive(#cccccc,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_PRZEZBRAJANIE = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#22bad9,-5%), derive(#22bad9,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_SUSZ_M = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#8d6e63,-5%), derive(#8d6e63,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_AWARIA_MASZYNY = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#dc143c,-5%), derive(#dc143c,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_AWARIA_FORMY = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#ff6347,-5%), derive(#ff6347,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    public static String STYL_BRAK_ZAOPATRZENIA = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#ffd700,-5%), derive(#ffd700,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_PRZERWA_P = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#008080,-5%), derive(#008080,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_BRAK_OPERATORA = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#8e44ad,-5%), derive(#8e44ad,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
    ...
    public static String STYL_WYBRAK = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#ff8c00,-5%), derive(#ff8c00,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
     ...
     public static String STYL_NIE_PODLACZONE = (
                                ...
                                "                          radial-gradient(center 50% 50%,radius 120%,derive(#ffffff,-5%), derive(#ffffff,30%));\n" +
                                "    -fx-background-insets: 0,1,2;\n" +
                                "    -fx-background-radius: 3 3 3 3, 3 3 3 3, 3 3 3 3;\n");
